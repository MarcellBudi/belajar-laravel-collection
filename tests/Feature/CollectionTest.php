...
class CollectionTest extends TestCase
{
    ...
    {
        $collection = collect(["Marcell"]);
        $result = $collection->mapInto(Person::class);
        $this->assertEquals([new Person("Marcell")], $result->all());
    }
    ...
    public function testMapSpread()
    {
        ...
        $this->assertEquals([
            new Person("Marcell Budi"),
            new Person("Budi Putra"),
        ], $result->all());
    }
    ...
    public function testCombine()
    {
        ...
        $collection2 = collect(["Marcell", "Indonesia"]);
    ...
    {
        $collection = collect(["Marcell", "Budi", "Budi"]);

        $this->assertEquals("Marcell-Budi-Budi", $collection->join("-"));
        $this->assertEquals("Marcell-Budi_Budi", $collection->join("-", "_"));
        $this->assertEquals("Marcell, Budi and Budi", $collection->join(", ", " and "));
    ...
    {
        $collection = collect(["Marcell", "Budi", "Putra"]);
        $this->assertTrue($collection->contains("Marcell"));
